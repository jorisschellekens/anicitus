 ...
 */
public class WeatherHumidityBlock extends IBlock{
    ...
    public Object[] process(Object[] in) {
        ...
        try {
            ...
            pressure = new JSONObject(txt).getJSONObject("query").getJSONObject("results").getJSONObject("channel").getJSONObject("atmosphere").getDouble("humidity");
        } catch (IOException e) {
            e.printStackTrace();
        }
